...
export default function MyLevelItem({
  ...
  return (
    <NavLink to={to} className="block" aria-label="마이페이지로 이동">
      {({ isActive }) => (
        <div
          className={cn(
            ...
            'hover:bg-main0 hover:border-main400 active:bg-main0 active:border-main400',
            (active || isActive) && 'bg-main0 border-main400'
          )}
        >
          <div
